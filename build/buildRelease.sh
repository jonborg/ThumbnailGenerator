...
tar -a -c -f "${THUMB// /}_v${VERSION//./_}.zip" "$EXE_FILE" "$README_FILE" "$THUMB_EXAMPLE_FILE" "$TOP_EXAMPLE_FILE" "$ASSET_FOLDER" "$ASSET_MASK_FOLDER" "$ASSET_DOCUMENTATION_FOLDER" "$SETTING_FOLDER"
