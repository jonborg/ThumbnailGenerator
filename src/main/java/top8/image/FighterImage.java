...
import top8.generate.PlayerSlot;

@Getter
public class FighterImage {
    private final Logger LOGGER = LogManager.getLogger(fighter.FighterImage.class);

    private final Fighter fighter;
    private final SlotImageSettings imageSettings;
    private final BufferedImage image;

    public FighterImage(Fighter fighter, SlotImageSettings imageSettings, BufferedImage image){
    ...
    private BufferedImage editImage(BufferedImage bufferedImage){
        ...
        bufferedImage = this.cropImage(bufferedImage,
                bufferedImage.getWidth() + imageSettings.getOffset()[0],
                bufferedImage.getHeight() + imageSettings.getOffset()[1]);
